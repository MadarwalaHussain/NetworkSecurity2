...
from network_security.components.data_transfomation import DataTransformation
...
from network_security.entity.artificat_entity import DataIngestionArtifact, DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
...
class TrainingPipeline:
    ...
    def run_pipeline(self):
        try:
            ...
            # Push the artifact and model to s3
