from network_security.entity.artificat_entity import DataIngestionArtifact, DataValidationArtifact
from network_security.entity.config_entity import DataValidationConfig
from network_security.logging.logger import logging
from network_security.exceptions.exception import NetworkSecurityException
from network_security.constants.training_pipeline import SCHEMA_FILE_PATH
from network_security.utils.main_untils import read_yaml_file, write_yaml_file
from scipy.stats import ks_2samp # data drift library
import os, sys
import pandas as pd
    ...
    def detect_data_drift(self, base_df, current_df, threshold=0.05)->bool:
        try:
            ...
            for column in base_df.columns:
                ...
                is_same_dist = ks_2samp(data1, data2)
